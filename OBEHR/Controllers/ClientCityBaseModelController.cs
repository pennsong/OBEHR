...
{
    public class ClientCityBaseModelController<Model> : BaseModelController<Model> where Model : ClientCityBaseModel, IEditable<Model>
    {
        public ClientCityBaseModelController()
        {
            ViewPath = "ClientCityBaseModel";
            ViewPathBase = "ClientCityBaseModel";
        }
        ...
        {
            var results = ClientCityBaseCommon<Model>.GetQuery(UW, includeSoftDeleted);
