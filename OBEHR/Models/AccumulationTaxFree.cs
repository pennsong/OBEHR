...
{
    public class AccumulationTaxFree : CitySupplierBaseModel, IEditable<AccumulationTaxFree>
    {
        public AccumulationTaxFree()
        {
            Name = "无";
        }
        ...
        public void Edit(AccumulationTaxFree model)
        {
            Name = model.Name;
